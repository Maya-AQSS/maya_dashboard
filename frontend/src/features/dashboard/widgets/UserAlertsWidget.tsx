...
const COLOR_CLASSES = {
 amber:'bg-warning-light dark:bg-warning-dark/20 border-warning/20 text-warning-dark',
 blue:'bg-info-light dark:bg-info-dark/20 border-info/20 text-info-dark',
 red:'bg-danger-light dark:bg-danger-dark/20 border-danger/20 dark:border-danger/50 text-danger-dark dark:text-danger',
 green:'bg-success-light dark:bg-success-dark/20 border-success/20 text-success-dark',
}

const BUTTON_CLASSES = {
 amber:'bg-warning-light hover:bg-warning/20 dark:bg-warning-dark/40 dark:hover:bg-warning-dark/60 text-warning-dark',
 blue:'bg-info-light hover:bg-info/20 dark:bg-info-dark/40 dark:hover:bg-info-dark/60 text-info-dark',
 ...
 green:'bg-success-light hover:bg-success/20 dark:bg-success-dark/40 dark:hover:bg-success-dark/60 text-success-dark',
}
...
function UserAlertsWidget() {
 ...
 {[1, 2].map((n) => (<div key={n} className="h-10 bg-outline-variant rounded-lg animate-pulse" />
 ))}
 </div>
 )
 }
 ...
 return (<div className="flex flex-col gap-2 overflow-auto h-full">
 {alerts.map((alert) => {
