...
describe('favoritesApi', () => {
 ...
 expect(fetch).toHaveBeenCalledWith('http://maya_dashboard_api.localhost/api/v1/dashboard/user/u-123/favorite-applications',
...
'Content-Type':'application/json',
 ...
 expect(fetch).toHaveBeenCalledWith('http://maya_dashboard_api.localhost/api/v1/dashboard/user/u-123/favorite-applications/42',
 expect.objectContaining({
 method:'DELETE',
 headers: expect.objectContaining({
 Accept:'application/json',
