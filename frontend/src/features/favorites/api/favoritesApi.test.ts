...
describe('favoritesApi', () => {
  ...
  describe('getFavorites', () => {
    it('devuelve array de favoritos con GET y Authorization header', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://maya-dashboard-api.maya.test/api/v1/dashboard/user/u-123/favorite-applications',
  ...
  describe('removeFavorite', () => {
    it('hace DELETE con applicationId en la URL y Authorization header', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://maya-dashboard-api.maya.test/api/v1/dashboard/user/u-123/favorite-applications/42',
        expect.objectContaining({
          method: 'DELETE',
          headers: expect.objectContaining({
            Accept: 'application/json',
