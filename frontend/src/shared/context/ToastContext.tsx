...
const STYLES = {
 success:'bg-success-light dark:bg-success-dark/30 border-success/20 text-success-dark dark:text-success-light',
 ...
 info:'bg-info-light dark:bg-info-dark/30 border-info/20 text-info-dark dark:text-info-light',
 warning:'bg-warning-light dark:bg-warning-dark/30 border-warning/20 text-warning-dark dark:text-warning-light',
}
