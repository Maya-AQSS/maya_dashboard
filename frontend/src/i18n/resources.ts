...
export const resources = {
  es: { common: deepMerge(baseEs, esCommon), auth: deepMerge(baseEs, esAuth) },
  va: { common: deepMerge(baseVa, vaCommon), auth: deepMerge(baseVa, vaAuth) },
  en: { common: deepMerge(baseEn, enCommon), auth: deepMerge(baseEn, enAuth) },
} as const
