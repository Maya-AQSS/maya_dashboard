...
FRONTEND_URL="https://dashboard.maya.test"
BACKEND_API_URL="https://dashboard-api.maya.test/api/v1"
DEFAULT_BACKEND_PORT="8003"
DEFAULT_FRONTEND_PORT="5175"

setup_frontend_env() {
    upsert_env_var frontend/.env VITE_API_URL            "${VITE_API_URL:-https://dashboard-api.maya.test/api/v1}"
